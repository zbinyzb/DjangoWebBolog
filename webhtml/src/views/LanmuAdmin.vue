          ...
          <el-row :gutter="10">
              <el-col :span="4">
               ...
               <div class="save-tree body dweb" style="float:left;">
                    <el-button @click="getLanmuTree()" type="warning" >恢复结构</el-button>
                    <el-button @click="saveLanmuTree()" type="success" >保存结构</el-button>
                    <el-button type="primary" >全部文章获取</el-button>
               </div>
              </el-col>
              <el-col :span="20">
                <div class="dweb">
                                    ...
                                    <el-col class="text-item" :xs="12" :lg="7">
                                        <el-popover
                                            ...
                                            <el-button 
                                                type="success"
                                                size="mini"
                                                @click="saveArticleToLanmu(item.id)">确定
                                            </el-button>
                                        </el-popover>
                                    </el-col>
                                </el-row>
...
export default {
    ...
    methods:{
        ...
        getLanmuTree(){
            axios({
                url:"http://127.0.0.1:9000/api/zbin-lanmu/",
                method:"get",
            }).then((res)=>{
                console.log(res.data)
